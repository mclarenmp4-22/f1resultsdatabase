...
cur.execute("UPDATE Drivers SET Starts = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.driverid = Drivers.ID AND GrandPrixResults.racestatus NOT LIKE '%Did not start%' AND GrandPrixResults.raceposition IS NOT NULL AND Drivers.needstatsupdate = 1)")
cur.execute("UPDATE Drivers SET Entries = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.driverid = Drivers.ID AND GrandPrixResults.raceposition IS NOT NULL AND Drivers.needstatsupdate = 1)")
cur.execute("UPDATE Drivers SET SprintStarts = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.driverid = Drivers.ID AND (GrandPrixResults.sprintstatus NOT LIKE '%Did not start%' OR GrandPrixResults.sprintstatus IS NULL) AND GrandPrixResults.sprintposition IS NOT NULL AND Drivers.needstatsupdate = 1)")
cur.execute("UPDATE Drivers SET SprintEntries = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.driverid = Drivers.ID AND GrandPrixResults.sprintposition IS NOT NULL AND Drivers.needstatsupdate = 1)")
...
cur.execute("UPDATE Constructors SET Starts = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.constructorid = Constructors.ID AND GrandPrixResults.racestatus NOT LIKE '%Did not start%' AND GrandPrixResults.raceposition IS NOT NULL AND Constructors.needstatsupdate = 1)")
cur.execute("UPDATE Constructors SET Entries = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.constructorid = Constructors.ID AND GrandPrixResults.raceposition IS NOT NULL AND Constructors.needstatsupdate = 1)")
cur.execute("UPDATE Constructors SET SprintStarts = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.constructorid = Constructors.ID AND (GrandPrixResults.sprintstatus NOT LIKE '%Did not start%' OR GrandPrixResults.sprintstatus IS NULL) AND GrandPrixResults.sprintposition IS NOT NULL AND Constructors.needstatsupdate = 1)")
cur.execute("UPDATE Constructors SET SprintEntries = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.constructorid = Constructors.ID AND GrandPrixResults.sprintposition IS NOT NULL AND Constructors.needstatsupdate = 1)")
...
cur.execute("UPDATE Engines SET Starts = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.engineid = Engines.ID AND GrandPrixResults.racestatus NOT LIKE '%Did not start%' AND GrandPrixResults.raceposition IS NOT NULL AND Engines.needstatsupdate = 1)")
cur.execute("UPDATE Engines SET Entries = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.engineid = Engines.ID AND GrandPrixResults.raceposition IS NOT NULL AND Engines.needstatsupdate = 1)")
cur.execute("UPDATE Engines SET SprintStarts = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.engineid = Engines.ID AND (GrandPrixResults.sprintstatus NOT LIKE '%Did not start%' OR GrandPrixResults.sprintstatus IS NULL) AND GrandPrixResults.sprintposition IS NOT NULL AND Engines.needstatsupdate = 1)")
cur.execute("UPDATE Engines SET SprintEntries = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.engineid = Engines.ID AND GrandPrixResults.sprintposition IS NOT NULL AND Engines.needstatsupdate = 1)")
...
cur.execute("UPDATE Chassis SET Starts = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.chassisid = Chassis.ID AND GrandPrixResults.racestatus NOT LIKE '%Did not start%' AND GrandPrixResults.raceposition IS NOT NULL AND Chassis.needstatsupdate = 1)")
cur.execute("UPDATE Chassis SET Entries = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.chassisid = Chassis.ID AND GrandPrixResults.raceposition IS NOT NULL AND Chassis.needstatsupdate = 1)")
cur.execute("UPDATE Chassis SET SprintStarts = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.chassisid = Chassis.ID AND (GrandPrixResults.sprintstatus NOT LIKE '%Did not start%' OR GrandPrixResults.sprintstatus IS NULL) AND GrandPrixResults.sprintposition IS NOT NULL AND Chassis.needstatsupdate = 1)")
cur.execute("UPDATE Chassis SET SprintEntries = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.chassisid = Chassis.ID AND GrandPrixResults.sprintposition IS NOT NULL AND Chassis.needstatsupdate = 1)")
...
cur.execute("UPDATE EngineModels SET Starts = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.enginemodelid = EngineModels.ID AND GrandPrixResults.racestatus NOT LIKE '%Did not start%' AND GrandPrixResults.raceposition IS NOT NULL AND EngineModels.needstatsupdate = 1)")
cur.execute("UPDATE EngineModels SET Entries = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.enginemodelid = EngineModels.ID AND GrandPrixResults.raceposition IS NOT NULL AND EngineModels.needstatsupdate = 1)")
cur.execute("UPDATE EngineModels SET SprintStarts = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.enginemodelid = EngineModels.ID AND (GrandPrixResults.sprintstatus NOT LIKE '%Did not start%' OR GrandPrixResults.sprintstatus IS NULL) AND GrandPrixResults.sprintposition IS NOT NULL AND EngineModels.needstatsupdate = 1)")
cur.execute("UPDATE EngineModels SET SprintEntries = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.enginemodelid = EngineModels.ID AND GrandPrixResults.sprintposition IS NOT NULL AND EngineModels.needstatsupdate = 1)")
...
cur.execute("UPDATE Tyres SET Starts = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.tyreid = Tyres.ID AND GrandPrixResults.racestatus NOT LIKE '%Did not start%' AND GrandPrixResults.raceposition IS NOT NULL AND Tyres.needstatsupdate = 1)")
cur.execute("UPDATE Tyres SET Entries = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.tyreid = Tyres.ID AND GrandPrixResults.raceposition IS NOT NULL AND Tyres.needstatsupdate = 1)")
cur.execute("UPDATE Tyres SET SprintStarts = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.tyreid = Tyres.ID AND (GrandPrixResults.sprintstatus NOT LIKE '%Did not start%' OR GrandPrixResults.sprintstatus IS NULL) AND GrandPrixResults.sprintposition IS NOT NULL AND Tyres.needstatsupdate = 1)")
cur.execute("UPDATE Tyres SET SprintEntries = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.tyreid = Tyres.ID AND GrandPrixResults.sprintposition IS NOT NULL AND Tyres.needstatsupdate = 1)")
...
cur.execute("UPDATE Teams SET Starts = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.teamid = Teams.ID AND GrandPrixResults.racestatus NOT LIKE '%Did not start%' AND GrandPrixResults.raceposition IS NOT NULL AND Teams.needstatsupdate = 1)")
cur.execute("UPDATE Teams SET Entries = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.teamid = Teams.ID AND GrandPrixResults.raceposition IS NOT NULL AND Teams.needstatsupdate = 1)")
cur.execute("UPDATE Teams SET SprintStarts = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.teamid = Teams.ID AND (GrandPrixResults.sprintstatus NOT LIKE '%Did not start%' OR GrandPrixResults.sprintstatus IS NULL) AND GrandPrixResults.sprintposition IS NOT NULL AND Teams.needstatsupdate = 1)")
cur.execute("UPDATE Teams SET SprintEntries = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.teamid = Teams.ID AND GrandPrixResults.sprintposition IS NOT NULL AND Teams.needstatsupdate = 1)")
...
cur.execute("UPDATE Nationalities SET Starts = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.nationalityid = Nationalities.ID AND GrandPrixResults.racestatus NOT LIKE '%Did not start%' AND GrandPrixResults.raceposition IS NOT NULL AND Nationalities.needstatsupdate = 1)")
cur.execute("UPDATE Nationalities SET Entries = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.nationalityid = Nationalities.ID AND GrandPrixResults.raceposition IS NOT NULL AND Nationalities.needstatsupdate = 1)")
cur.execute("UPDATE Nationalities SET SprintStarts = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.nationalityid = Nationalities.ID AND (GrandPrixResults.sprintstatus NOT LIKE '%Did not start%' OR GrandPrixResults.sprintstatus IS NULL) AND GrandPrixResults.sprintposition IS NOT NULL AND Nationalities.needstatsupdate = 1)")
cur.execute("UPDATE Nationalities SET SprintEntries = (SELECT COUNT(*) FROM GrandPrixResults WHERE GrandPrixResults.nationalityid = Nationalities.ID AND GrandPrixResults.sprintposition IS NOT NULL AND Nationalities.needstatsupdate = 1)")
